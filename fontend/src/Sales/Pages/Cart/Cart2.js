...
function Cart2() {
  ...
  for (let i = 0; i < items.length; i++) {
    ...
    cartTable.push(
      <tr key={i + 1} className={Style.listItem} id={ID}>
        <th scope="row">{i + 1}</th>
        <td>{author_name}</td>
        <td>{product_name}</td>
        <td>{price}</td>
  ...
  return (
    <>
      ...
      {/* 輸入框 */}
      <form>
        <section id="inputName" className={Style.blockText}>
          <div>姓名</div>
          <input
            type="text"
            disabled
        ...
        <section id="inputTel" className={Style.blockText}>
          <div>聯絡方式</div>
          <input
            type="text"
            disabled
        ...
        <section id="inputPrice" className={Style.blockText}>
          <div>總價</div>
          <input
            type="text"
            disabled
